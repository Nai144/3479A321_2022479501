...
class _MyHomePageState extends State<MyHomePage> {
           ...
           Card(
            child:Column(
              ...
              children: <Widget>[
                ...
                Text(
                  '${context.watch<AppData>().counter}', // El contador proviene de AppData
  ...
  TextButton _createDecrementButton() {
    return TextButton(
                    onPressed:(){ Provider.of<AppData>(context, listen: false).decrementCounter();
                    },
  ...
  TextButton _createIncrementButton() {
    return TextButton(
                    onPressed: (){ Provider.of<AppData>(context, listen: false).incrementCounter();
                    },
